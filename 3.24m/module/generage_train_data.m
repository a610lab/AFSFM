...
dataT1_CSF_DTI_baseline=PPMI_238_62NC_142PD_34SWEDD_mat_add_age_sex(:,2:end);  
dataT1_CSF_DTI_baseline=cell2mat(dataT1_CSF_DTI_baseline);

load final_mat_12m_data_186_54NC_123PD_9SWEDD_add_age_sex;
dataT1_CSF_DTI_12m=final_mat_12m_data(:,2:end);  
dataT1_CSF_DTI_12m=cell2mat(dataT1_CSF_DTI_12m);
zeros_column=zeros(186,1);
dataT1_CSF_DTI_12m=[dataT1_CSF_DTI_12m(:,1:1278),zeros_column,dataT1_CSF_DTI_12m(:,1279:end)];

dataT1_CSF_DTI=[dataT1_CSF_DTI_baseline;dataT1_CSF_DTI_12m];  
