...
data_YScore=[mergeflag,data_YScore];   
...
if(isYscoresCentering==1)  
    L=my_convert2Sparse_impro(L); % Subtract the mean from each value, divide by the standard deviation, and convert the result into a sparse matrix.
end
...
Ite=pars.Ite;                       % number of iterations
    ...
    for l3 = 1:len3                             
        ...
        for l2 = 1:len2                          
            ...
            for l1 = 1:len1
                ...
                for kk = 1:kFold 
                    ...
                    parfor ii = 1:pars.k1 
                        [trainData,trainFlag,testData,testFlag,Atrain,Atest,Btrain,Btest,Ctrain,Ctest,Dtrain,Dtest,Ytrain] = my_Gen_samplesY2_impro(...
                            ...
                            scoresCpar1,scoresCpar2,... % Positive sample/Negative sample label smellScores
                        ...
                        [fsAcc(kk,ii),fsSen(kk,ii),fsSpec(kk,ii),fsPrec(kk,ii),maxFscore(kk,ii),fsAuc1(kk,ii),...
                            ...
                            Rs1{kk,ii},Ra1{kk,ii},Rb1{kk,ii},Rc1{kk,ii},Rd1{kk,ii}]=my_combineSVM_SVR_maxFS_impro_SVR2_add_age_sex_impro(...
                ...
                Res1=my_updateRes_impro_lambda_4_impro_uar(Res1,fsAcc,fsSen,fsSpec,fsPrec,maxFscore,fsAuc1,...
                    maxAcc1,minArmse1,maxBcc1,minBrmse1,maxCcc1,minCrmse1,maxDcc1,minDrmse1,...
                    Rs1,Ra1,Rb1,Rc1,Rd1,l1,l2,l3,l4,SelectFeaIdx,W);
