function [fsAcc,fsSen,fsSpec,fsPrec,maxFscore,fsAuc,maxAcc,AccRmse,maxBcc,BccRmse,maxCcc,CccRmse,maxDcc,DccRmse,Rs,Ra,Rb,Rc,Rd]=...
    my_combineSVM_SVR_maxFS_impro_SVR2_add_age_sex_impro(trainData,trainFlag,trainScoresA,trainScoresB,trainScoresC,trainScoresD,...
...
[maxCcc,CccRmse,CccDec,CccTest,CccBest_X,CccBest_Y]=my_findBestCc_SVR_impro(Ccc,Crmse,Cdec,Ctest);
